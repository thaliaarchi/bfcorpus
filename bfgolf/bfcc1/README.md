...
MD5 digests were computed from programs with comments removed, except for
duplicate submissions, which had a letter appended to disambiguate. When
commented versions of the programs are available, the submitted version is in a
corresponding .b.orig file.
